...
var baseurl = BASE_URL.substr(0,BASE_URL.indexOf("index.php"));
...
function createprofile(){
	...
	if(profilename == ""){
		...
		if(profilename !== null ) {
	   		url = baseurl+"index.php/jmbasetheme/index/createProfile";
...
function cloneprofile(oldprofile){
	...
	if(profilename == ""){
		...
		if(profilename !== null ) {
			url = baseurl+"index.php/jmbasetheme/index/cloneProfile";
...
function restoreprofile(profilename){
    data = {};
    url = baseurl+"index.php/jmbasetheme/index/restoreProfile";
    data["profile"] = profilename;
	sbmitform(url,data);
}
...
function deleteprofile(profilename){
	data = {};
	url = baseurl+"index.php/jmbasetheme/index/deleteProfile";
	data["profile"] = profilename;
	sbmitform(url,data);
}
...
function saveprofile(){
    ...
    profilename = jQuery.trim(profilename).replace(' ', '').toLowerCase();
    data = {};
    url = baseurl+"index.php/jmbasetheme/index/saveProfile";
    data["profile"] = profilename;
