...
class Wavethemes_Jmbasetheme_Helper_Data extends Mage_Core_Helper_Abstract
{
		...
		public function getactiveprofile(){
		    ...
		    if($devicedetect->isTablet()){
		         $baseconfig["productlistdeslenght"] = $baseconfig["productlistdeslenghttablet"]?$baseconfig["productlistdeslenghttablet"]:$baseconfig["productlistdeslenght"];
                 $baseconfig["showlabel"] = $baseconfig["showlabeltablet"]?$baseconfig["showlabeltablet"]:$baseconfig["showlabel"];
                 $baseconfig["productgridnumbercolumn"] = $baseconfig["productgridnumbercolumntablet"]?$baseconfig["productgridnumbercolumntablet"]:$baseconfig["productgridnumbercolumn"];
                 $baseconfig["quanlityperpage"] = $baseconfig["quanlityperpagetablet"]?$baseconfig["quanlityperpagetablet"]:"";
                 $baseconfig["productlimageheight"] = $baseconfig["productlimageheighttablet"]?$baseconfig["productlimageheighttablet"]:$baseconfig["productlimageheight"];
                 $baseconfig["productlimageheightportrait"] = $baseconfig["productlimageheighttabletportrait"]?$baseconfig["productlimageheighttabletportrait"]:$baseconfig["productlimageheight"];
                 ...
                 $baseconfig["productlimagewidth"] = $baseconfig["productlimagewidthtablet"]?$baseconfig["productlimagewidthtablet"]:$baseconfig["productlimagewidth"];
		         $baseconfig["productlimagewidthportrait"] = $baseconfig["productlimagewidthtabletportrait"]?$baseconfig["productlimagewidthtabletportrait"]:$baseconfig["productlimagewidth"];
		         ...
		         $baseconfig["productlistdeslenght"] = $baseconfig["productlistdeslenghttmobile"]?$baseconfig["productlistdeslenghtmobile"]:$baseconfig["productlistdeslenght"];
                 $baseconfig["showlabel"] = $baseconfig["showlabelmobile"]?$baseconfig["showlabelmobile"]:$baseconfig["showlabel"];
                 $baseconfig["productgridnumbercolumn"] = $baseconfig["productgridnumbercolumnmobile"]?$baseconfig["productgridnumbercolumnmobile"]:$baseconfig["productgridnumbercolumn"];
                 $baseconfig["quanlityperpage"] = $baseconfig["quanlityperpagemobile"]?$baseconfig["quanlityperpagemobile"]:"";
                 $baseconfig["productlimageheight"] = $baseconfig["productlimageheightmobile"]?$baseconfig["productlimageheightmobile"]:$baseconfig["productlimageheight"];
                 $baseconfig["productlimagewidth"] = $baseconfig["productlimagewidthmobile"]?$baseconfig["productlimagewidthmobile"]:$baseconfig["productlimagewidth"];
		    }
		    return  $baseconfig;
